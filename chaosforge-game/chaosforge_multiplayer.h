#ifndef CHAOSFORGE_MULTIPLAYER_H
#define CHAOSFORGE_MULTIPLAYER_H

#pragma once

/* This file was automatically generated by cbindgen. Do not modify. */
 ...
 */
int coreria_get_performance_metrics(struct PerformanceMetrics *metrics);
 ...
 * Returns 0 on success, negative on error
 */
int coreria_get_match_state(unsigned int match_id, struct MatchState *state);
 ...
 * Returns 0 on success, negative on error
 */
int coreria_get_player_state(unsigned int player_id, struct PlayerState *state);
 ...
 * Returns 0 on success, negative on error
 */
int coreria_send_input(unsigned int player_id, struct InputAction action);

/**
 * Send multiple input actions in a batch
 */
int coreria_send_input_batch(unsigned int player_id,
                             const struct InputAction *actions,
                             int action_count);
 ...
 */
int coreria_is_action_active(unsigned int player_id, struct InputAction action);
...
#endif /* CHAOSFORGE_MULTIPLAYER_H */
